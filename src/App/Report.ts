...
let c4 = new $.UI.CenterFlowContainer()
...
let options: $.UI.Entries = {
  "Test": { type: 'checkbox', label: "enabled", },
  "place": { type: 'empty' },
  "OK": { type: 'button', label: "Ok", },
  "Cancle": { type: 'button', label: "Abbrechen", },
  "year": { type: 'listbox', label: "Jahr", text: ["hi", "tes"] },

}
new $.UI.Form(options, "Dateneingabe").createForm(c4)
